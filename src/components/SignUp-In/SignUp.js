    ...
    return (
        <div className="signup">
            ...
            <Form onSubmit={handleSubmit} >
                ...
                <Form.Group className="mb-4" controlId="formBasicPhone_2">
                ...
                <Form.Group className="mb-4" controlId="formBasicPassword_1">
