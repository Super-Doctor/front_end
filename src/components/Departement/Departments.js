...
//                                     {departments.map((department, idx) => {
//                                         return (
//                                             <Card onClick={() => myDepartment(department.id)}>
//                                                 <div className="cardBodyAndShadow"></div>
//                                                 {department.departmentType === 'Eyes' &&
//                                                     <Card.Img variant="top" src={eye} height="180" style={{ width: "auto", margin: "1rem", borderRadius: "16px", objectFit: "cover" }} />
//                                                 }
//                                                 {department.departmentType === 'Skin' &&
//                                                     <Card.Img variant="top" src={skin} height="180" style={{ width: "auto", margin: "1rem", borderRadius: "16px", objectFit: "cover" }} />
//                                                 }
//                                                 {department.departmentType === 'Bones' &&
//                                                     <Card.Img variant="top" src={bone} height="180" style={{ width: "auto", margin: "1rem", borderRadius: "16px", objectFit: "cover" }} />
//                                                 }
//                                                 {department.departmentType === 'Heart' &&
//                                                     <Card.Img variant="top" src={heart} height="180" style={{ width: "auto", margin: "1rem", borderRadius: "16px", objectFit: "cover" }} />
//                                                 }
//                                                 {department.departmentType === 'Children' &&
//                                                     <Card.Img variant="top" src={children} height="180" style={{ width: "auto", margin: "1rem", borderRadius: "16px", objectFit: "cover" }} />
//                                                 }
//                                                 {department.departmentType === 'Kidney' &&
//                                                     <Card.Img variant="top" src={kidney} height="180" style={{ width: "auto", margin: "1rem", borderRadius: "16px", objectFit: "cover" }} />
//                                                 }
...
//                                                         </Typography>
//                                                         <Typography variant="body2" color="text.secondary" >
//                                                             <h5> Department Chief : {department.leaderName} </h5>

//                                                         </Typography>
//                                                         <Typography variant="body2" color="text.secondary" >
//                                                             <h5>   Phone Number:{department.phoneNumber} </h5>
//                                                         </Typography>


//                                                         <Typography variant="body2" color="text.secondary" >
//                                                             <h5>  Working Days: {department.workingDays}</h5>

//                                                         </Typography>
//                                                         <Typography variant="body2" color="text.secondary" >
//                                                             <h5> Working Hours: from morning {department.workingHours} evening</h5>
